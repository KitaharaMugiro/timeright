...
import { Calendar, Star, TrendingUp, Gamepad2, Shield, Settings2, Users, UserSearch, Link2 } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/admin/users', label: 'ユーザ一覧', icon: UserSearch },
  ...
  { href: '/admin/affiliates', label: 'アフィリエイト', icon: Link2 },
